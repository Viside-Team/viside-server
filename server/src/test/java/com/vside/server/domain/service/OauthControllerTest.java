package com.vside.server.domain.service;
...
public class OauthControllerTest {
    ...
    public void 회원탈퇴(){
        ...
        ResponseEntity<WithdrawalResponseDto> err_res =  oAuthController.withdrawal(WithdrawalRequestDto.builder().snsId("200").build());
